...
class Model(nn.Module):
    ...
    def compute_param_num(self, ):
        ...
        total_param = 0
        for i in range(self.layer_num):
            in_channel, out_channel, in_pn, out_pn, weight_num, max_neighbor_num, neighbor_num_lst, neighbor_id_lstlst, conv_layer, residual_layer, residual_rate, neighbor_mask_lst, zeros = \
                self.layer_lst[i]
            if (len(conv_layer) != 0):
                param_num = 0
